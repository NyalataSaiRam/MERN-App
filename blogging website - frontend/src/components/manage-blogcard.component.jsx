        ...
        <div className="flex flex-col justify-between py-2 w-full min-w[300px]">
          ...
          <div className="flex gap-6 mt-3">
            ...
            <button
              ...
              className="pr-4 py-2 underline text-red/80"
            >
              Delete
            </button>
          </div>
      ...
      <div className="flex gap-5 lg:gap-10 pb-6 border-b mb-6 border-grey">
        ...
        <div>
          ...
          <div className="flex gap-6 mt-3">
            ...
            <button onClick={(e)=>deleteBlog(blog, access_token, e.target)} className="pr-4 py-2 underline text-red/80">Delete</button>
          </div>
        </div>
      </div>
    );
