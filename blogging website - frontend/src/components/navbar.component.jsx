...
const Navbar = () => {
  ...
  const {
    userAuth,
    userAuth: { access_token, profile_img, new_notification_available, isAdmin }, setUserAuth
  ...
  return (
    <>
      <nav className="navbar z-50">
        ...
        <div
          className={
            `absolute bg-white w-full left-0 top-full mt-0.5 border-b border-grey py-4 px-[5vw] md:border-0 md:block md:relative md:inset-0 md:p-0 md:show md:w-auto ` +
