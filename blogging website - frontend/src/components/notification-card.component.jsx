      ...
      >
        ...
        {type != "like" ? (
          <p className="ml-14 pl-5 font-gelasio  text-xl my-5">
            {comment? comment.comment:<span className=" text-xl pl-2 pt-1 pb-1 font-normal text-white bg-dark-grey/40 rounded-md">This message was deleted 🧐</span>}
          </p>
        ) : (
          ""
        )}
        ...
        {reply ? (
          <div className="ml-20 p-5 bg-grey mt-5 rounded-md">
            ...
            <button
              className="ml-14 mt-2 underline hover:text-black"
